...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'is_management'); ?>
		<?php echo $form->textField($model,'is_management'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'is_ban'); ?>
		<?php echo $form->textField($model,'is_ban'); ?>
	</div>
