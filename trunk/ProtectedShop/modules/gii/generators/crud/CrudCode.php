...
class CrudCode extends CCodeModel
{
	...
	public function generateActiveLabel($modelClass,$column,$array="")
	{
        $str_arr="";
        if($array!="")
        {
        ...
        return "\$form->labelEx(\$model,'{$column->name}'".$str_arr.")";
	}

	public function generateActiveField($modelClass,$column,$array="")
	{
        $str_arr="";
        if($array!="")
        {
