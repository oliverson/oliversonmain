...
<?php endif; ?>
<?php if ($page == 'index' || $page == 'index_v2'): ?>
	<!-- Dashboard Script -->
	<script src="<?php echo getURL(); ?>theme/scripts/index.js" type="text/javascript"></script>
...
<?php endif; ?>
<?php if ($page == 'index' || $page == 'index_v2' || $page == 'finances' || $page == 'charts'): ?>
		...
		if ($('.sparkline').length)
		{
			$.each($('.sparkline'), function(k,v) 
			{
				...
				{ 
					...
					width: 150,
					height: 28,
					stackedBarColor: ["#dadada", themerPrimaryColor],
					spotRadius: 3,
					lineWidth: 2
				});
			});
	...
	var charts = 
	{
		...
		utility:
		{
			chartColors: [ "#47759e", "#444", "#777", "#999", "#DDD", "#EEE" ],
		...
		<?php if ($page == 'index_v2' || $page == 'index'): ?>
		...
		<?php endif; ?>
		<?php if ($page == 'charts' || $page == 'index' || $page == 'index_v2'): ?>
...
<?php if ($page == 'gallery'): ?>
	...
	<script src="<?php echo getURL(); ?>theme/scripts/Bootstrap-Image-Gallery/js/bootstrap-image-gallery.min.js" type="text/javascript"></script>
